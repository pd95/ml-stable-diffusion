...
def make_case(step_count: int) -> dict:
    ...
    if step_count == 4:
        ...
        step_result = scheduler.step(output, scheduler.timesteps[0], step_sample)
        case["step_first"] = {
    ...
    if step_count == 3:
        ...
        step_result = scheduler.step(output, scheduler.timesteps[1], step_sample)
...
def main() -> None:
    output_path = Path("swift/StableDiffusionTests/Resources/euler_reference.json")
    fixture = {
